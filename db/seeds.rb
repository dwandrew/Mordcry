...
Spell.create(spell_name:"Spell of Doom", spell_diff: 8, description:"Urging the restless spirits of the city to rise up in fury, the Necromancer directs their fury at a single foe. Choose one enemy within 12\", that unit needs to pass a strength test, if they fail they must roll on the Injury chart to see what happens.", spell_warband: "The Undead")
Spell.create(spell_name:"Call of Vanhel", spell_diff: 6, description:"", spell_warband: "The Undead")
Spell.create(spell_name:"Spell of Awakening", spell_diff: 2, description:"", spell_warband: "The Undead")
