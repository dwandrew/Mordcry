...
Spell.create(spell_name:"Call of Vanhel", spell_diff: 6, description:"Uttering words of power the Necromancer instills energy into dead flesh. One Zombie or Dire Wolf within 6\" of the necromancer can make an immediate bonus move up to its movement distance. If it moves into contact with an enemy model, it counts as charging for any subsequent activation", spell_warband: "The Undead")
