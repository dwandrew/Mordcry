...
Ability.create(name: "Parry", effect:	"Can roll one dice, if this beats the lowest successful hits dice roll, then ignore the damage from it. Cannot parry crits.")
Ability.create(name: "Penetrating", effect: "Weapon ignores one point of armour")
...
Add +(*) (listed in weapon stats) to Strength if the first activation is used to attack. But not for the second activation (and any consecutive activations this turn) if it is also used to attack.")
Ability.create(name: "Damaging", effect:	"Blows calculated at +(*) Strength (listed in weapon stats)")
...
Ability.create(name: "Gromril Weapon", effect: "(CC only)	Weapon ignores a point of armour, increase Damage and Crit Damage of the weapon by +1")
...
Skill.create(name: "Spellcaster", description: "This Warrior may cast spells, and can chooses a single spell from the Appropriate list, whenever they learn a new skill they can choose a new spell instead or reduce the difficultly of one they already have by 1", skill_category: "Generic")
...
Skill.create(name: "Mutations", description: "This Warrior has been twisted by the cursed nature of their surroundings and when purchased can be given Mutations from the mutations list.", skill_category: "Special" )
Skill.create(name: "Perfect Killer", description: "The Warrior has honed the killing arts, and now all attacks ignore 1 point of armour", skill_category: "Combat" )
...
Equipment.create(name: "Morningstar" ,	range: "1",	attacks: 4,	damage: "1 / 3", strength: "As User", cost: 10, category: "One handed close").abilities<< Ability.find_by_name("Flailing")
Equipment.create(name: "Fist" ,	range: "1",	attacks: 4,	damage: "1 / 2", strength: "As User", cost: 0, category: "One handed close").abilities<< Ability.find_by_name("Blunt")
...
Equipment.create(name: "Flail" ,	range: "2",	attacks: 4,	damage: "1 / 5", strength: "As User +(*)", cost: 15, category:"Two handed close").abilities<< Ability.find_by_name("Flailing")
